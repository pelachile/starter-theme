...
namespace CCWP\Config;

//TODO use php array_merge or wp_parse_args to reduce redundant setting of theme defaults
...
add_filter( 'simple_social_default_styles', __NAMESPACE__ . '\social_default_styles' );
/**
 ...
 */
function social_default_styles( $defaults ) {
